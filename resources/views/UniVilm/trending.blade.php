...
<div id="searchOverlay" class="search-overlay">
    ...
    <input type="text" name="q" placeholder="Search film..." required>
</form>
...
<div class="slider">
    ...
    <div class="slides" id="slides">
        <img src="img/sore.jpg" draggable="false">
